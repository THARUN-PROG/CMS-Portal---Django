...
def register_student(request):
    ...
    if request.method == 'POST':
        if student_form.is_valid():
            first_name = student_form.clean_firstname.get('firstname')
    ...
    return render(request, 'main_app/register_student.html', context)
...
def add_course(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            messages.error(request, "The course should not be empty")
